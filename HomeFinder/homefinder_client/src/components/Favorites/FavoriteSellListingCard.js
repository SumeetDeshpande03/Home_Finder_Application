...
class FavoriteSellListingCard extends React.Component {
    ...
    onViewListingClick = e => {
      e.preventDefault();
      this.setState({ redirect: <Redirect to={{pathname: '/viewListing', state: {searchCard: this.props.searchCard, type:"buy", flow: 'Favorites'}}} /> });
    }
...
export default FavoriteSellListingCard;